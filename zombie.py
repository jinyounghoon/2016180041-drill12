...
class Zombie:
    ...
    def find_ball(self):
        ...
        distance2 = (ball.x - self.x) ** 2 + (ball.y - self.y) ** 2
    ...
    def build_behavior_tree(self):
        ...
        escape_to_player_node = LeafNode("Escape to player", self.escape_to_player)
    ...
    def draw(self):
        self.font.draw(self.x - 20, self.y + 60, '%d' % (self.hp), (255, 0, 0))
